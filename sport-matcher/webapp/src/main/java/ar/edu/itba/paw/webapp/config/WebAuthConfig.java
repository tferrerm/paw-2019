        ...
        http
        	...
        	.userDetailsService(userDetailsService)
        		.authorizeRequests()
	                ...
	                .antMatchers(HttpMethod.POST, "/pitches/*/events/*/join", "/pitches/*/events/*/leave", "/pitches/*/events/*/upvote",
	                		"/pitches/*/events/*/downvote", "/pitches/*/events/*/kick-user/*")
	                		.access("hasRole('ROLE_USER')")
	                .antMatchers(HttpMethod.DELETE, "/pitches/*/events/*").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
	                .antMatchers("/events/**").permitAll()
	                .antMatchers(HttpMethod.POST, "/clubs/*/comment").access("hasRole('ROLE_USER')")
	                .antMatchers("/clubs/**").permitAll()
	                .antMatchers(HttpMethod.POST, "/pitches/*/events").access("hasRole('ROLE_USER')")
	                .antMatchers("/pitches/**").permitAll()
	                .antMatchers(HttpMethod.POST, "/tournaments/*/teams/*/join",
	                		"/tournaments/*/leave").access("hasRole('ROLE_USER')")
