	...
	<div class="main-container">
		...
		<div class="content-container">
			...
			<div class="table-navigator">
				...
				<div>
                    <a href="<c:url value='/pitches/${page+1}${queryString}' />"><button type="button" class="btn btn-secondary"><spring:message code="next"/></button></a>
                    <a href="<c:url value='/pitches/${lastPageNum}${queryString}' />"><button type="button" class="btn btn-secondary"><spring:message code="last"/></button></div>
			    </div>
            </div>
        </div>
    </body>
