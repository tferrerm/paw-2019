...
define([], function() {
    ...
    zero_events: 'There are no events yet but... You can be the first to create one!',
    empty_history: 'You haven\'t participated in any events yet but... There\'s plenty of matches waiting for you!',
